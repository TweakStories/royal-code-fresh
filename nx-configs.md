...
--- START OF FILE libs/core/navigation/project.json ---
{
  "name": "util",
  "$schema": "../../../node_modules/nx/schemas/project-schema.json",
...
--- START OF FILE libs/core/navigation/tsconfig.json ---
{
  "extends": "../../../../tsconfig.base.json",
  "compilerOptions": {
    "target": "es2023",
...
--- START OF FILE libs/features/social/domain/project.json ---
{
  ...
  "prefix": "lib",
  "projectType": "library",
  "tags": ["type:domain", "scope:features-social"],
  "targets": {
    "build": {
      "executor": "@nx/angular:package",
      "outputs": ["{workspaceRoot}/dist/{projectRoot}"],
      "options": {
        "project": "libs/features/social/domain/ng-package.json"
      },
      "configurations": {
        "production": {
          "tsConfig": "libs/features/social/domain/tsconfig.lib.prod.json"
        },
        "development": {
...
--- START OF FILE libs/shared/base-models/project.json ---
{
  ...
  "targets": {
    "build": {
      ...
      "outputs": ["{workspaceRoot}/dist/{projectRoot}"],
      "options": {
        "project": "libs/shared/base-models/ng-package.json"
      },
      "configurations": {
        "production": {
          "tsConfig": "libs/shared/base-models/tsconfig.lib.prod.json"
        },
        "development": {
    ...
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/shared/base-models/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE libs/ui/breadcrumb/project.json ---
{
  ...
  "tags": ["scope:shared-ui", "type:ui", "context:navigation"],
  "targets": {
    "build": {
      "executor": "@nx/angular:package",
      "outputs": ["{workspaceRoot}/dist/{projectRoot}"],
      "options": {
        "project": "libs/ui/breadcrumb/ng-package.json"
      },
      "configurations": {
        "production": {
          "tsConfig": "libs/ui/breadcrumb/tsconfig.lib.prod.json"
        },
        "development": {
          "tsConfig": "libs/ui/breadcrumb/tsconfig.lib.json"
        }
      },
      "defaultConfiguration": "production"
    },
    ...
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/ui/breadcrumb/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE libs/ui/card/jest.config.ts ---
export default {
  displayName: 'card',
  preset: '../../../jest.preset.js',
  setupFilesAfterEnv: ['<rootDir>/src/test-setup.ts'],
...
--- START OF FILE libs/ui/card/package.json ---
{
    "name":  "@royal-code/ui/card",
    "version":  "0.0.1",
    "sideEffects":  false
}
--- END OF FILE ---

--- START OF FILE libs/ui/card/project.json ---
{
  "name": "card",
  "$schema": "../../../node_modules/nx/schemas/project-schema.json",
...
--- START OF FILE libs/ui/card/tsconfig.json ---
{
  "compilerOptions": {
    "target": "es2023",
    "forceConsistentCasingInFileNames": true,
...
--- START OF FILE libs/ui/card/tsconfig.spec.json ---
{
  "extends": "./tsconfig.json",
  "compilerOptions": {
    "outDir": "../../../dist/out-tsc",
...
--- START OF FILE libs/ui/faq/project.json ---
{
  ...
  "targets": {
    ...
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/ui/faq/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE libs/ui/forms/project.json ---
{
  ...
  "prefix": "royal-code",
  "projectType": "library",
  "tags": ["scope:shared", "type:ui", "context:forms"],
  "targets": {
    "test": {
      "executor": "@nx/jest:jest",
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
...
--- START OF FILE libs/ui/pagination/project.json ---
{
  ...
  "targets": {
    ...
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/ui/pagination/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE libs/ui/quantity-input/project.json ---
{
  ...
  "targets": {
    ...
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/ui/quantity-input/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE libs/ui/title/project.json ---
{
  ...
  "targets": {
    "test": {
      ...
      "outputs": ["{workspaceRoot}/coverage/{projectRoot}"],
      "options": {
        "jestConfig": "libs/ui/title/jest.config.ts"
      }
    },
    "lint": {
      "executor": "@nx/eslint:lint"
...
--- START OF FILE tsconfig.base.json ---
{
  ...
  "compilerOptions": {
    ...
    "paths": {
      ...
      "@royal-code/core/logging": ["libs/core/core-logging/src/index.ts"],
      "@royal-code/core/navigation/util": ["libs/core/navigation/src/index.ts"],
      ...
      "@royal-code/features/map": ["libs/features/map/src/index.ts"],
      "@royal-code/features/media": ["libs/features/media/src/index.ts"],
      ...
      "@royal-code/features/orders": ["libs/orders/src/index.ts"],
      ...
      "@royal-code/features/social": ["libs/features/social/src/index.ts"],
      ...
      "@royal-code/features/social/data-access-plushie": [
        "libs/features/social/data-access-plushie/src/index.ts"
      ],
      ...
      "@royal-code/models": ["libs/shared/models/src/index.ts"],
      ...
      "@royal-code/ui/card": ["libs/ui/card/src/index.ts"],
      ...
      "@royal-code/ui/resource-battery": [
        "libs/ui/resource-battery/src/index.ts"
      ],
