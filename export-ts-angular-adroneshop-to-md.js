...
const OUTPUT_FILE = '_docs/frontend-droneshop-code.md';
...
const DIRECTORIES_TO_SCAN = [
    ...
    //   'libs/shared/utils',
    //   'libs/features/whishlist',
    'libs/features/products/core',
    'libs/features/products/domain',
    'libs/features/products/data-access-droneshop',
      'libs/features/products/ui-droneshop',
    'libs/core/routing/src/lib',
    'libs/ui/breadcrumb',
    'libs/features/social',
    // 'libs/features/reviews',

    'libs/ui/language-selector',
    // 'libs/core/navigation',
    'libs/core',
    'libs/features/guides',
    // 'libs/ui/icon',
    // 'libs/ui/button',
    // 'libs/ui/badge',
    // 'libs/features/test',
...
const DIRECTORIES_TO_SCAN_old = [
    'apps/droneshop',
    //   'libs/features',
    //   'libs/shared',
    'libs/shared/domain/src/lib/models/navigation',
    'libs/core/routing/src/lib',
    'libs/ui/breadcrumb',
    //   'libs/core',
...
const MANDATORY_FILES = [
    ...
    'libs/shared/styles/src/lib/theme.scss', // of 'apps/plushie-paradise/src/styles.scss'
    'tsconfig.base.json',
    //   'apps/plushie-paradise/src/app/app.module.ts',
    //   'libs/shared/domain/src/lib/navigation.model.ts',
